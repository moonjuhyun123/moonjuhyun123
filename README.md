...
- 개인 환경에서 노트북 서버를 직접 구성해  
  Kubernetes 클러스터 구축 및 운영
- 컨테이너 배포, 서비스 구성, 장애 상황을 직접 실험하며  
  **운영 관점의 Kubernetes 사용 경험** 축적 중
- 레거시 운영 경험을 바탕으로  
  컨테이너 기반 환경으로 운영 역량 확장 중
